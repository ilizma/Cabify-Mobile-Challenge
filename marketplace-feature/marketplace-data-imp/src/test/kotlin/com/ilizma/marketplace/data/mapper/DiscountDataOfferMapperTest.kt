...
class DiscountDataOfferMapperTest {
    ...
    inner class From {
        ...
        @Test
        fun `given Promotion DiscountDescription and discountDataList, when from is called, then result should be te expected offer`() {
            // given
        ...
        @Test
        fun `given Bulk DiscountDescription and discountDataList, when from is called, then result should be te expected offer`() {
            // given
